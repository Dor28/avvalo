...
Revision ID: 0010_knowledge_card_overrides
Revises: 0009_rule_overrides
"""
...
revision: str = "0010_knowledge_card_overrides"
down_revision: str | None = "0009_rule_overrides"
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.UniqueConstraint("card_id", name="uq_knowledge_card_override_card_id"),
    )
