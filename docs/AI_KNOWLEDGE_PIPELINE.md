...
| Privacy-safe persistence | ✅ Implemented and tested | Active check and router paths persist only IDs, enums, versions, and metrics. No table carries a content column: `story_submission` and its `minimized_text` were dropped in migration `0013` |
